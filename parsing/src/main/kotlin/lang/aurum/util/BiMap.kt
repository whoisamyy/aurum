// Implementation by Michael Rozumyanskiy
// src: https://github.com/MichaelRocks/bimap/blob/master/src/main/kotlin/io/michaelrocks/bimap/BiMap.kt
...
class LinkedHashBiMap<K : Any, V : Any>(capacity: Int = 16)
    : AbstractBiMap<K, V>(LinkedHashMap(capacity), LinkedHashMap(capacity)) {
    companion object {
        fun <K : Any, V : Any> create(map: Map<K, V>): LinkedHashBiMap<K, V> {
            val bimap = LinkedHashBiMap<K, V>()
            bimap.putAll(map)
            return bimap
        }
    }
